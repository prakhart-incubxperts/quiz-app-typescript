      ...
      <Box sx={{ flexGrow: 1 }} className={'py-1'}>
        <AppBar position="absolute">
          <Toolbar>
            ...
            <Button color='secondary' className='mx-2' variant="contained" type='button' name='user' value="user" onClick={handleToggle} href='/account'><PersonIcon name='user' fontSize='small'/>User</Button>
          </Toolbar>
        </AppBar>
      </Box>
      <Modal
